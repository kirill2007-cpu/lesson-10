...
# Задание на дом
Зарегистрироваться на сервисе https://codepen.io/

# Вопросы студента
<strong>Вопрос:</strong> Используется ли где-то еще HTML кроме как в браузере? </br>
<strong>Ответ:</strong>Нет, HTML используется только для вебразработки и рендериться браузером. Но!!! Сам HTML это XML, а XML раньше активно использовался для передачи данных. Сейчас же вместо XML спользуется JSON, кроме каких-то очень старых проектов.
<br />
<br />
<br />
<p align="center">
